...
var _injectGlobal = (function (stringifyRules, css) {
  var injectGlobal = function injectGlobal() {
    if (process.env.NODE_ENV !== 'production') {
      warnOnce('Warning: Usage of `injectGlobal` will be deprecated in styled-components >=4.0.0. It will be replaced with `createGlobalStyle`.');
    }
...
var _GlobalStyle = (function (stringifyRules) {
  var GlobalStyle = function () {
    ...
    GlobalStyle.prototype.updateStyles = function updateStyles(executionContext, styleSheet) {
  ...
  var WithTheme = function (_React$Component) {
    ...
    WithTheme.prototype.componentWillMount = function componentWillMount() {
      ...
      if (styledContext === undefined && themeProp === undefined && process.env.NODE_ENV !== 'production') {
        if (!isStyledComponent(Component$$1)) {
          // eslint-disable-next-line no-console
...
var _createGlobalStyle = (function (stringifyRules, css) {
  ...
  var createGlobalStyle = function createGlobalStyle(strings) {
    ...
    var GlobalStyleComponent = function (_React$Component) {
      ...
      GlobalStyleComponent.prototype.componentWillMount = function componentWillMount() {
        var props = this.props;

        var sheet = this.context[CONTEXT_KEY] || StyleSheet.master;
        var context = style.isStatic ? STATIC_EXECUTION_CONTEXT : _extends({}, props);

        style.createStyles(context, sheet);
      };

      GlobalStyleComponent.prototype.componentWillReceiveProps = function componentWillReceiveProps(props) {
        var sheet = this.context[CONTEXT_KEY] || StyleSheet.master;
        var context = style.isStatic ? STATIC_EXECUTION_CONTEXT : _extends({}, props);
      ...
      GlobalStyleComponent.prototype.render = function render() {
        if (process.env.NODE_ENV !== 'production') {
          if (typeof this.props.children !== 'undefined') {
            // eslint-disable-next-line no-console
            console.warn('[createGlobalStyle] received children which will not be rendered. Please use the component without passing children elements.');
          }
        }
    ...
    GlobalStyleComponent.contextTypes = (_GlobalStyleComponent = {}, _GlobalStyleComponent[CONTEXT_KEY] = PropTypes.oneOfType([PropTypes.instanceOf(StyleSheet), PropTypes.instanceOf(ServerStyleSheet)]), _GlobalStyleComponent);
...
export { createGlobalStyle, css, keyframes, injectGlobal, isStyledComponent, consolidateStreamedStyles, ThemeProvider, wrapWithTheme as withTheme, ServerStyleSheet, StyleSheetManager, __DO_NOT_USE_OR_YOU_WILL_BE_HAUNTED_BY_SPOOKY_GHOSTS };
