...
var _createGlobalStyle = (function (stringifyRules, css) {
  ...
  var createGlobalStyle = function createGlobalStyle(strings) {
    ...
    GlobalStyleComponent.contextTypes = (_GlobalStyleComponent = {}, _GlobalStyleComponent[CONTEXT_KEY] = index$4.oneOfType([index$4.instanceOf(StyleSheet), index$4.instanceOf(ServerStyleSheet)]), _GlobalStyleComponent);
